...
## Key Concepts
- console.group is mostly about reachability: values stay alive while something reachable still references them.
...
## Why It Matters
Memory issues are expensive because they usually show up after a feature already works. Knowing console.group helps you keep long-running sessions stable, investigate leaks methodically, and avoid premature fixes that only hide symptoms.
...
## Interview Angle
- **Q:** What is console.group?  
  **A:** Give the mental model first, then show a tiny example.
- **Q:** Why would you use console.group in production?  
  **A:** Explain the readability, correctness, or maintainability benefit.

## Mini Challenge
Write the smallest example you can that proves you understand console.group.

## Mini Challenge Solution
A good solution is short, runnable, and includes the exact output or behavior you expect.

## Related Topics
- Previous: [console.table](12-console-table.md)
- Next: [console.time](14-console-time.md)
