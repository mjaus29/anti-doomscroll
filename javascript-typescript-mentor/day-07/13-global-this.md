...
## Why It Matters
This matters in day-to-day engineering because globalThis affects how readable, predictable, and maintainable your code feels under change. Once you know the mental model, you can choose the feature on purpose instead of copying patterns blindly.
...
- **Q:** Why would you use globalThis in production?  
  **A:** Explain the readability, correctness, or maintainability benefit.

## Mini Challenge
Write the smallest example you can that proves you understand globalThis.

## Mini Challenge Solution
A good solution is short, runnable, and includes the exact output or behavior you expect.

## Related Topics
- Previous: [top-level await](12-top-level-await.md)
- Next: [Array.fromAsync](14-array-from-async.md)
